_gitname="libsigrokdecode-tm1637"
pkgname=${_gitname}-git
pkgver=r4.1cbf39e
pkgrel=1
pkgdesc="Stacked protocol decoder of 7-segment digital tubes driver TM1637 on TMC bus for logic analyzing application sigrok"
arch=('any')
url="https://github.com/malinges/${_gitname}"
license=('unknown')
groups=()
depends=('libsigrokdecode' 'libsigrokdecode-tmc-git')
makedepends=('git')
